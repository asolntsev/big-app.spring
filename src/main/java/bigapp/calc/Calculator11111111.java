...
@RestController
public class Calculator11111111 {
    private final CalculatorService8 service;

    Calculator11111111(CalculatorService8 service) {
        this.service = service;
    }
    public static Object debug() {return Util.get();}

    @RequestMapping(value = "/calc/add11111111", method = GET)
