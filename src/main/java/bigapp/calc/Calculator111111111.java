...
@RestController
public class Calculator111111111 {
    private final CalculatorService9 service;

    @Autowired
    Calculator111111111(CalculatorService9 service) {
        this.service = service;
    }

    public static Object debug() {return Util.get();}

    @RequestMapping(value = "/calc/add111111111", method = GET)
