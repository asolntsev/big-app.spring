...
@RestController
public class Calculator1111 {
    private final CalculatorService4 service;

    Calculator1111(CalculatorService4 service) {
        this.service = service;
    }

    public static Object debug() {return Util.get();}

    @RequestMapping(value = "/calc/add1111", method = GET)
