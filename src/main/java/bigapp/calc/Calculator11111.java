...
@RestController
public class Calculator11111 {
    private final CalculatorService5 service;

    Calculator11111(CalculatorService5 service) {
        this.service = service;
    }

    public static Object debug() {return Util.get();}

    @RequestMapping(value = "/calc/add11111", method = GET)
